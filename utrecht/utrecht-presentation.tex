...
\begin{center}
\includegraphics[scale=1.05]{figmodel.pdf}
\end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dave }\FunctionTok{=}\NormalTok{ H.compile }\StringTok{"Location1"} \StringTok{"D"} \FunctionTok{$} \KeywordTok{do} 
\NormalTok{    code }\OtherTok{<-}\NormalTok{ receive }
\NormalTok{    applyFunction code }\DataTypeTok{VUnit}
\end{Highlighting}
\end{Shaded}
