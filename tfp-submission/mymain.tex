...
\NormalTok{    (_, participant, _) }\OtherTok{<-}\NormalTok{ State.get}
    \DataTypeTok{HighLevelProgram} \FunctionTok{$}\NormalTok{ lift }\FunctionTok{$}\NormalTok{ liftFree (}\DataTypeTok{Send}\NormalTok{ participant value ())  }
...
\NormalTok{    variableName }\OtherTok{<-}\NormalTok{ uniqueVariableName }
    \DataTypeTok{HighLevelProgram} \FunctionTok{$}\NormalTok{ lift }\FunctionTok{$}\NormalTok{ liftFree (}\DataTypeTok{Receive}\NormalTok{ participant variableName ())}
...
\OtherTok{compile ::} \DataTypeTok{Location} \OtherTok{->} \DataTypeTok{Participant} \OtherTok{->} \DataTypeTok{HighLevelProgram}\NormalTok{ a }\OtherTok{->} \DataTypeTok{Program}\NormalTok{ value}
