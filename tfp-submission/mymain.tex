...
Choreographies are defined in terms of \emph{global types}, which declaratively describe a protocol among two or more participants. 
...
(Below we often use `choreographies' and `global types' as synonyms.)
...
% standardly coupled with a structural congruence on configurations/processes.

\begin{remark}[Colors]
Throughout the paper, we  use colors to improve readability. 
In particular, %we use colors to distinguish the elements for forward and backward semantics:
