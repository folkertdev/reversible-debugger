...
As delegation is when a participant can delegate (a part of)
...
also present in \texttt{TypeContext}, the data type we define for representing local types (see below). 
